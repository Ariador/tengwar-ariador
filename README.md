![20250208 Tengwar Ariador Regular Font](https://github.com/user-attachments/assets/f21fe04e-859b-40cf-885a-f1457eb7c0e1)
...
Another font for the fictional Tengwar script developed by the great J.R.R.Tolkien for his immense Arda Universe. The font is free and open source (the FontForge SFD file is included). This work is to be considered as fanfiction. All the rights to the word "Tengwar" and the script itself belong to their respectful owners - the Tolkien Estate.
